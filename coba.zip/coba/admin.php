    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 hidden md:flex flex-col">
            ...
            <nav class="flex-1 py-4">
                <a href="#" class="block py-3 px-6 bg-yellow-500 text-white font-medium border-l-4 border-yellow-200">Data Guru</a>
                <a href="index.php" target="_blank" class="block py-3 px-6 text-gray-400 hover:bg-gray-800 transition">Lihat Website</a>
            </nav>
            <div class="p-4 border-t border-gray-800">
                <a href="logout.php" class="flex items-center text-yellow-400 hover:text-yellow-300">Logout</a>
            </div>
        </aside>
